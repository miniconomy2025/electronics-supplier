...
CREATE TABLE material_orders (
  ...
  ordered_at NUMERIC(1000,2) NOT NULL,
  received_at NUMERIC(1000,2)
);
...
CREATE TABLE material_supplies (
  ...
  material_id INT NOT NULL,
  received_at NUMERIC(1000,2) NOT NULL,
  processed_at NUMERIC(1000,2) NOT NULL
);
...
CREATE TABLE machine_orders (
  ...
  external_order_id INT,
  order_status INT NOT NULL DEFAULT 1,
  placed_at NUMERIC(1000,2) NOT NULL,
  received_at NUMERIC(1000,2)
);
...
CREATE TABLE machines (
  ...
  purchased_at NUMERIC(1000,2) NOT NULL,
  received_at NUMERIC(1000,2),
  removed_at NUMERIC(1000,2),
...
CREATE TABLE electronics (
  ...
  produced_at NUMERIC(1000,2) NOT NULL,
  electronics_status INT NOT NULL DEFAULT 1,
  sold_at NUMERIC(1000,2)
);
...
CREATE TABLE lookup_values (
  ...
  changed_at NUMERIC(1000,2) NOT NULL
);
