...
namespace esAPI.Controllers
{
    [ApiController]
    [Route("simulation")]
    public class SimulationController(SimulationStartupService simulationStartupService, SimulationDayOrchestrator dayOrchestrator, ISimulationStateService stateService, IStartupCostCalculator costCalculator, ICommercialBankClient bankClient, AppDbContext context, BankService bankService, BankAccountService bankAccountService, RecyclerApiClient recyclerClient, ILogger<SimulationController> logger, ILoggerFactory loggerFactory, RetryQueuePublisher retryQueuePublisher) : ControllerBase
    {
        ...
        public async Task<IActionResult> AdvanceDay()
        {
            ...
            var engine = new SimulationEngine(_context, _bankService, _bankAccountService, _dayOrchestrator, _costCalculator, _bankClient, _recyclerClient, _loggerFactory.CreateLogger<SimulationEngine>(), _retryQueuePublisher);
